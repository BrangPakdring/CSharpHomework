...
namespace Program2
{
	public partial class Form1 : Form
	{
		...
		{
			if (ClearAndDrawCheckBox.Checked == true)
				graphics?.Clear(SystemColors.Control);
			DrawCayleyTree(TreeDepthNumericUpDown.Value, 350, 350, 100,
				-Math.PI / 2, (double) KOffsetTrackBar.Value / 100);
		}
		...
		private void ColorComboBox_SelectedIndexChanged(object sender,
			EventArgs e)
		{
		...
		private void RandomlyAssign<T>(T o)
		{
			...
			if (value == null || min == null || max == null)
				throw new Exception("RandomlyAssign failed.");
			value.SetValue(o,
				random.Next((int) min.GetValue(o), (int) max.GetValue(o)));
		}
	}
}